...
getResolveFuncInjected = (url, params) ->
  return ['$q', '$http', '$location', 'ngProgress', getResolveFunc(url, params)]
...
routes =
  '/':
    ...
    resolve:
      posts: getResolveFuncInjected '/api/v1/posts'
  '/tags':
    templateUrl: '/static/templates/tags.html'
    controller: 'TagsCtrl'
    resolve:
      data: getResolveFuncInjected '/api/v1/posts/tags'
  '/tags/:tag':
    templateUrl: '/static/templates/tags.html'
    controller: 'TagsCtrl'
    resolve:
  ...
  '/archives':
    ...
    resolve:
      posts: getResolveFuncInjected '/api/v1/posts/archives'
  '/:category/:year/:month/:day/:file':
    templateUrl: '/static/templates/post-detail.html'
    controller: 'PostDetailsCtrl'
    resolve:
      post: ['$route', '$q', '$http', '$location', 'ngProgress', ($route, $q, $http, $location, ngProgress) ->
        params =
